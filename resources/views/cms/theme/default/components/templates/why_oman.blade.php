...
<x-dynamic-component
    ...
    <section
            class="container bg-light-gray/60 backdrop-blur-2xl md:rounded-lg sticky top-0 z-30 overflow-x-scroll navbar">
    ...
    <section class="py-36 container" id="2024_vision" dir="rtl">
                                ...
                                <a href="#" target="_blank"
                                   class="flex items-center gap-3 transition duration-300 group-hover/tall-link:translate-x-1 motion-reduce:transition-none motion-reduce:group-hover/tall-link:transform-none">
                                    ...
                                    <div class="flex items-end">
                                        <span
                                                class="relative -left-0.5 text-lg transition duration-500 motion-reduce:transition-none break-words">
                            ...
                            <div x-ref="tall_stack_description"
                                ...
                                <div class="flex justify-center min-[600px]:justify-start min-[700px]:justify-end">
                                    <div class="text-center">
                                        <div class="text-2xl">
                                            {{ __('global.four-axios-for-vision') }}
                                        </div>
                                        <div class="grid">
            ...
            @foreach($page->data['competitive_advantages'] as $advantage)
                <div class="flex flex-col">
                    <div class="relative">
                        ...
                        <img src="{{ asset('image/polygon-pink.svg') }}" class="absolute -top-6 right-0 -z-10 ltr:left-0 ltr:right-auto ltr:rotate-180" alt="">
                    </div>
    ...
    <section class="py-16 container">
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <div class="flex items-start flex-col w-full md:w-1/3 md:rtl:-mr-24 md:-ml-24">
    ...
    <section class="py-24 container flex flex-col md:flex-row items-center" id="support_investors">
        ...
        <div class="flex-1 mr-5 ltr:ml-5 ltr:mr-0 mt-16 md:mt-0">
    ...
    <section class="py-24 container" id="support_investors">
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="text-white bg-primary p-10 rounded-t-2xl md:rounded-r-2xl md:rounded-l-2xl md:ltr:rounded-r-none">
                <div class="relative">
            ...
            <div class="text-white bg-light-gray p-10 rounded-b-2xl md:rounded-l-2xl  md:rounded-r-2xl md:ltr:rounded-l-none">
                <div class="relative">
    ...
    <section class="py-36 container" id="success-framework">
        ...
        <div class="flex items-center justify-center">
            <div class="relative w-[857px] h-[851px] rounded-3xl p-5 md:p-10 flex items-end"
                ...
                <img src="{{ asset('image/2-traingol.svg') }}" class="absolute -top-10 -right-10 w-32 hidden md:block"
                     alt="">
                <img src="{{ asset('image/cercle-2.svg') }}" class="absolute top-1/2 -left-10 w-32 hidden md:block"
                     alt="">
            </div>
        </div>
    </section>
    ...
    <section class="py-24 container" id="support_investors">
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="text-white rounded-t-2xl md:rounded-r-2xl rounded-b-none md:ltr:rounded-r-none md:rounded-l-2xl w-full h-96 md:h-auto ltr:rounded-b-none"
                 style="background: url('/storage/{{ $page->data['natural_col_2_image'] }}'); background-size: cover; background-position: top center;">

            </div>
            <div class="text-white bg-primary px-10 py-24 rounded-none md:rounded-l-2xl md:ltr:rounded-l-none md:rounded-r-2xl rounded-b-none ltr:rounded-b-none">
                <div class="relative">
            ...
            <div class="text-white bg-light-gray px-10 py-24 rounded-none md:rounded-r-2xl ltr:rounded-t-none md:ltr:rounded-r-none md:rounded-l-2xl rounded-t-none">
                <div class="relative">
            ...
            <div class="text-white rounded-b-2xl md:rounded-l-2xl rounded-t-none ltr:rounded-t-none md:ltr:rounded-l-none md:rounded-r-2xl w-full h-96 md:h-auto"
                 style="background: url('/storage/{{ $page->data['natural_col_2_image'] }}'); background-size: cover; background-position: top center;">
    ...
    <section class="py-24 container" id="investor-residency-program">
        ...
        <div class="w-full flex flex-col md:flex-row">
            <div class="flex items-center justify-center w-full md:w-1/2">
                ...
                <div class="flex items-start flex-col w-2/3 rtl:-mr-44 mt-24 ltr:-ml-36">
    ...
    <section class="py-24 container" id="support_investors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mt-6">
            <div class="text-white bg-primary p-10 rounded-t-2xl md:rounded-r-2xl md:ltr:rounded-l-2xl md:ltr:rounded-r-none">
                <div class="relative">
            ...
            <div class="text-white bg-light-gray p-10  rounded-b-2xl md:rounded-l-2xl md:ltr:rounded-r-2xl md:ltr:rounded-l-none">
                <div class="relative">
    ...
    <section class="py-24 container" id="support_investors">
        ...
        <a href="{{ $page->data['investor_residency_program_link'] }}"
           class="flex  items-center justify-between space-y-4 bg-gradient-to-tr from-[#E35656] to-[#9B2E2E] rounded-lg mt-11 p-6">
            ...
            <div>
                <img src="{{ asset('image/arow-left.svg') }}" class="ltr:rotate-180 ltr:-mt-4" alt="">
            </div>
        </a>
