<div>
    <div class="container bg-secondary rounded-3xl flex flex-col md:flex-row items-center justify-between p-10">
        <div class="w-full">
            <h1 class="text-primary text-3xl font-bold">{{ __('complaint.title') }}</h1>
            <p class="text-md text-gray-800 mt-3">{{ __('complaint.description') }}</p>
            <form wire:submit="send">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-7">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" wire:model="cr"
                               class="p-6 bg-white border-0 rounded-lg w-full outline-none"
                               style="box-shadow: 0px 2px 0px #9B2E2E;">
                    ...
                    <div class="mb-4">
                        <label for="" class="flex mb-2 text-[#9B2E2E] items-center">
                            <img src="{{ asset('image/polygon-small-dark.svg') }}" class="ltr:mr-2" alt="">
                            {{ __('complaint.summation_type') }} *
                        </label>
                        <div class="flex">
                            <div class="flex items-center me-4">
                                <input id="inline-radio" type="radio" name="submission_type" value="1"
                                ...
                                <label for="inline-radio"
                                       class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('complaint.online') }}</label>
                            </div>
                            <div class="flex items-center me-4">
                                <input id="inline-2-radio" checked name="submission_type" type="radio" value="0"
                                       wire:model="submission_type"
                                       class="w-4 h-4 text-[#9B2E2E] bg-gray-100 border-gray-300 focus:ring-[#9B2E2E] dark:focus:ring-[#9B2E2E] dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="inline-2-radio"
                                       class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('complaint.offline') }}</label>
                            </div>
                        </div>
                        <div class="text-red-600 mt-3">@error('submission_type') {{ $message }} @enderror</div>
                    </div>
                    <div class="mb-4">
                        <label for="" class="flex mb-2 text-[#9B2E2E] items-center">
                            <img src="{{ asset('image/polygon-small-dark.svg') }}" class="ltr:mr-2" alt="">
