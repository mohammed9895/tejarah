...
<x-dynamic-component
    ...
    <section class="bg-gradient-to-b from-primary/20 to-white py-48 {{ $pb ?? 'pb-48' }} text-center w-full mt-[-132px] absolute">
    </section>
    ...
    <div class="container">
        ...
        <section class="bg-light-gray rounded-2xl relative">
            ...
            <div class="owl-carousel rounded-2xl">
                <div class="item rounded-2xl flex items-center justify-start p-10"
                     style="background: url('/storage/{{ $page->data['slider_1_image'] }}'); background-size: cover; width: 100%; height:800px">
                    <div class="w-2/3 z-50">
                        <h1 class="text-5xl font-bold text-white leading-relaxed">{{ $page->data['slider_1_title'] }}</h1>
                        <p class="text-white mt-5">{{ $page->data['slider_1_description'] }}</p>
                        <div class="flex mt-5">
                            <a href="{{ $page->data['slider_1_primary_button_link'] }}"
                               class="bg-primary text-white p-3 rtl:ml-3 rounded-md">{{ $page->data['slider_1_primary_button_text'] }}</a>
                            <a href="{{ $page->data['slider_1_secondary_button_link'] }}"
                ...
                <div class="item rounded-2xl flex items-center justify-start p-10"
                     style="background: url('/storage/{{ $page->data['slider_2_image'] }}'); background-size: cover; width: 100%; height:800px">
                    <div class="w-2/3 z-50">
                        <h1 class="text-5xl font-bold text-white leading-relaxed">{{ $page->data['slider_2_title'] }}</h1>
                        <p class="text-white mt-5">{{ $page->data['slider_2_description'] }}</p>
                        <div class="flex mt-5">
                            <a href="{{ $page->data['slider_2_primary_button_link'] }}"
                               class="bg-primary text-white p-3 rtl:ml-3 rounded-md">{{ $page->data['slider_2_primary_button_text'] }}</a>
                            <a href="{{ $page->data['slider_2_secondary_button_link'] }}"
                ...
                <div class="item rounded-2xl flex items-center justify-start p-10"
                     style="background: url('/storage/{{ $page->data['slider_3_image'] }}'); background-size: cover; width: 100%; height:800px">
                    <div class="w-2/3 z-50">
                        <h1 class="text-5xl font-bold text-white leading-relaxed">{{ $page->data['slider_3_title'] }}</h1>
                        <p class="text-white mt-5">{{ $page->data['slider_3_description'] }}</p>
                        <div class="flex mt-5">
                            <a href="{{ $page->data['slider_3_primary_button_link'] }}"
                               class="bg-primary text-white p-3 rtl:ml-3 rounded-md">{{ $page->data['slider_3_primary_button_text'] }}</a>
                            <a href="{{ $page->data['slider_3_secondary_button_link'] }}"
                            ...
                            <div
                                ...
                                <div class="text-left rtl:text-right">
                                    <h1 class="text-3xl font-bold text-[{{ $site['starting_color'] }}] group-hover:text-white"
                                        style="color: {{ $site['starting_color'] }};">{{ $site['title'] }}</h1>
 ...
 w-24 h-24 rounded-full bg-white shadow text-[{{ $site['starting_color'] }}] text-5xl leading-[96px] text-center group-hover:block"
